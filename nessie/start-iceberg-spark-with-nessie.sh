spark-sql \
  --jars nessie/jar/nessie-spark-extensions-3.3_2.12-0.103.6.jar,nessie/jar/iceberg-spark-runtime-3.3_2.12-1.8.1.jar,nessie/jar/iceberg-aws-bundle-1.9.2.jar \
